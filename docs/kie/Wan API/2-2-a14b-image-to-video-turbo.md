# 2 2 A14b Image To Video Turbo API Documentation

> Generate content using the 2 2 A14b Image To Video Turbo model

## Overview

This document describes how to use the 2 2 A14b Image To Video Turbo model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `wan/2-2-a14b-image-to-video-turbo` |
...
|----------|-------|-------------|
| **Format** | `wan/2-2-a14b-image-to-video-turbo` | The exact model identifier for this API |
...
- **Default Value**: `"https://file.aiquickdraw.com/custom-page/akr/section-images/1755166042585gtf2mlrk.png"`
...
```json
{
  ...
  "data": {
    ...
    "model": "wan/2-2-a14b-image-to-video-turbo",
    "state": "waiting",
    "param": "{\"model\":\"wan/2-2-a14b-image-to-video-turbo\",\"input\":{\"image_url\":\"https://file.aiquickdraw.com/custom-page/akr/section-images/1755166042585gtf2mlrk.png\",\"prompt\":\"Overcast lighting, medium lens, soft lighting, low contrast lighting, edge lighting, low angle shot, desaturated colors, medium close-up shot, clean single shot, cool colors, center composition.The camera captures a low-angle close-up of a Western man outdoors, sharply dressed in a black coat over a gray sweater, white shirt, and black tie. His gaze is fixed on the lens as he advances. In the background, a brown building looms, its windows glowing with warm, yellow light above a dark doorway. As the camera pushes in, a blurred black object on the right side of the frame drifts back and forth, partially obscuring the view against a dark, nighttime background.\",\"resolution\":\"720p\",\"aspect_ratio\":\"auto\",\"enable_prompt_expansion\":false,\"seed\":42,\"acceleration\":\"none\"}}",
    "resultJson": "{\"resultUrls\":[\"https://file.aiquickdraw.com/custom-page/akr/section-images/1755166974320fuhbuhqh.mp4\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
