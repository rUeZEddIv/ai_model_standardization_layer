# V2 1 Master Text To Video API Documentation

> Generate content using the V2 1 Master Text To Video model

## Overview

This document describes how to use the V2 1 Master Text To Video model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `kling/v2-1-master-text-to-video` |
...
|----------|-------|-------------|
| **Format** | `kling/v2-1-master-text-to-video` | The exact model identifier for this API |
...
- **Default Value**: `"First-person view from a soldier jumping from a transport plane — the camera shakes with turbulence, oxygen mask reflections flicker — as the clouds part, the battlefield below pulses with anti-air fire and missile trails."`
