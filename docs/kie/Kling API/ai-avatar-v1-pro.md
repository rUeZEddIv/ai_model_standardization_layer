# Ai Avatar V1 Pro API Documentation

> Generate content using the Ai Avatar V1 Pro model

## Overview

This document describes how to use the Ai Avatar V1 Pro model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `kling/ai-avatar-v1-pro` |
...
|----------|-------|-------------|
| **Format** | `kling/ai-avatar-v1-pro` | The exact model identifier for this API |
...
- **Default Value**: `"https://file.aiquickdraw.com/custom-page/akr/section-images/175792685809077e8h8k3.png"`
...
- **Default Value**: `"https://file.aiquickdraw.com/custom-page/akr/section-images/1757925802302srqfkcqh.mp3"`
...
```json
{
  ...
  "data": {
    ...
    "model": "kling/ai-avatar-v1-pro",
    "state": "waiting",
    "param": "{\"model\":\"kling/ai-avatar-v1-pro\",\"input\":{\"image_url\":\"https://file.aiquickdraw.com/custom-page/akr/section-images/175792685809077e8h8k3.png\",\"audio_url\":\"https://file.aiquickdraw.com/custom-page/akr/section-images/1757925802302srqfkcqh.mp3\",\"prompt\":\"Enter your prompt here...\"}}",
    "resultJson": "{\"resultUrls\":[\"https://file.aiquickdraw.com/custom-page/akr/section-images/1757926879010qwlwajok.mp4\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
