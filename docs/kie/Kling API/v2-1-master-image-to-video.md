# V2 1 Master Image To Video API Documentation

> Generate content using the V2 1 Master Image To Video model

## Overview

This document describes how to use the V2 1 Master Image To Video model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `kling/v2-1-master-image-to-video` |
...
|----------|-------|-------------|
| **Format** | `kling/v2-1-master-image-to-video` | The exact model identifier for this API |
...
- **Default Value**: `"A team of paratroopers descends into enemy territory, as they pass through clouds, the camera switches to a slow pan above the battlefield lighting up with"`
...
- **Default Value**: `"https://file.aiquickdraw.com/custom-page/akr/section-images/1755256297923kmjpynul.png"`
...
- **Type**: `string`
- **Required**: No
- **Description**: Negative prompt to exclude certain elements from the video
