# V1 Avatar Standard API Documentation

> Generate content using the V1 Avatar Standard model

## Overview

This document describes how to use the V1 Avatar Standard model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `kling/v1-avatar-standard` |
...
|----------|-------|-------------|
| **Format** | `kling/v1-avatar-standard` | The exact model identifier for this API |
...
- **Default Value**: `"https://file.aiquickdraw.com/custom-page/akr/section-images/17579268936223zs9l3dt.png"`
...
- **Default Value**: `"https://file.aiquickdraw.com/custom-page/akr/section-images/17579258340109gghun47.mp3"`
...
```json
{
  ...
  "data": {
    ...
    "model": "kling/v1-avatar-standard",
    "state": "waiting",
    "param": "{\"model\":\"kling/v1-avatar-standard\",\"input\":{\"image_url\":\"https://file.aiquickdraw.com/custom-page/akr/section-images/17579268936223zs9l3dt.png\",\"audio_url\":\"https://file.aiquickdraw.com/custom-page/akr/section-images/17579258340109gghun47.mp3\",\"prompt\":\"Enter your prompt here...\"}}",
    "resultJson": "{\"resultUrls\":[\"https://file.aiquickdraw.com/custom-page/akr/section-images/1757926906464eurrqe4z.mp4\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
