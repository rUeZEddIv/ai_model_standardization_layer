...
```json
{
  ...
  "data": {
    ...
    "model": "qwen/image-to-image",
    "state": "waiting",
    "param": "{\"model\":\"qwen/image-to-image\",\"input\":{\"prompt\":\"Enter your prompt here...\",\"image_url\":\"\",\"strength\":0.8,\"output_format\":\"png\",\"acceleration\":\"none\",\"negative_prompt\":\"blurry, ugly\",\"seed\":42,\"num_inference_steps\":30,\"guidance_scale\":2.5,\"enable_safety_checker\":true}}",
