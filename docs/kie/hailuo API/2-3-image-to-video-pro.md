# 2 3 Image To Video Pro API Documentation

> Generate content using the 2 3 Image To Video Pro model

## Overview

This document describes how to use the 2 3 Image To Video Pro model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `hailuo/2-3-image-to-video-pro` |
...
|----------|-------|-------------|
| **Format** | `hailuo/2-3-image-to-video-pro` | The exact model identifier for this API |
...
- **Default Value**: `"https://file.aiquickdraw.com/custom-page/akr/section-images/1761736831884xl56xfiw.webp"`
...
```json
{
  ...
  "data": {
    ...
    "model": "hailuo/2-3-image-to-video-pro",
    "state": "waiting",
    "param": "{\"model\":\"hailuo/2-3-image-to-video-pro\",\"input\":{\"prompt\":\"A graceful geisha performs a traditional Japanese dance indoors. She wears a luxurious red kimono with golden floral embroidery, white obi belt, and white tabi socks. Soft and elegant hand movements, expressive pose, sleeves flowing naturally. Scene set in a Japanese tatami room with warm ambient lighting, shoji paper sliding doors, and cherry blossom branches hanging in the foreground. Cinematic, soft depth of field, high detail fabric texture, hyper-realistic, smooth motion.\",\"image_url\":\"https://file.aiquickdraw.com/custom-page/akr/section-images/1761736831884xl56xfiw.webp\",\"duration\":\"6\",\"resolution\":\"768P\"}}",
    "resultJson": "{\"resultUrls\":[\"https://file.aiquickdraw.com/custom-page/akr/section-images/17617367954436exivpkv.mp4\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
