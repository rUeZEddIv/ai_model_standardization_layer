...
<ParamField path="data.data[].status" type="string" required>
  Generation status:
...
<ParamField path="data.data[].error_message" type="string">
...
<Warning>
  ...
  * Pay attention to handling lyrics generation failure cases, check the error\_message field for specific error information
</Warning>
...
<Card title="Poll Query Results" icon="radar" href="/suno-api/get-lyrics-details">
