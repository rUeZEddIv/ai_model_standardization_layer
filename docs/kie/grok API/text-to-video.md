...
```json
{
  ...
  "data": {
    ...
    "model": "grok-imagine/text-to-video",
    "state": "waiting",
    "param": "{\"model\":\"grok-imagine/text-to-video\",\"input\":{\"prompt\":\"A couple of doors open to the right one by one randomly and stay open, to show the inside, each is either an living room, or a kitchen, or a bedroom or an office, with little people living inside.\",\"aspect_ratio\":\"2:3\",\"mode\":\"normal\"}}",
