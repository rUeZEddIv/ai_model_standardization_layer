# Character Remix API Documentation

> Generate content using the Character Remix model

## Overview

This document describes how to use the Character Remix model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `ideogram/character-remix` |
...
|----------|-------|-------------|
| **Format** | `ideogram/character-remix` | The exact model identifier for this API |
...
- **Default Value**: `"https://file.aiquickdraw.com/custom-page/akr/section-images/1755768466167d0tiuc6e.webp"`
...
- **Accepted File Types**: image/jpeg, image/png, image/webp
- **Multiple Files**: Yes
- **Default Value**: `["https://file.aiquickdraw.com/custom-page/akr/section-images/1755768479029sugx0g6f.webp"]`
...
- **Type**: `number`
- **Required**: No
- **Description**: Strength of the input image in the remix Default value: 0.8
